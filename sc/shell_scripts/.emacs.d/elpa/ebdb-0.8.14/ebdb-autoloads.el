;;; ebdb-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
All the important work is done by the `ebdb-db-load' method." nil nil)
...
Make a copy of the current *EBDB* buffer, renaming it." t nil)
...
Create a record, prompting for database and record class." t nil)
...
Open a buffer in `ebdb-mode'; do nothing else." t nil)
...
buffer to force an update." t nil)
...
Start reading the EBDB Info manual." t nil)

(autoload 'ebdb-help "ebdb-com" "\
Print a short help message." t nil)
...
only useful in Message buffer." t nil)

(autoload 'ebdb-complete-enable "ebdb-complete" "\
Enable ebdb-complete, it will rebind TAB key in `message-mode-map'." t nil)
...
Select EBDB contacts using the ivy/counsel interface." t nil)
...
Preconfigured `helm' for EBDB." t nil)
...
for their symbol representations." nil nil)
...
Export EBDB records to ispell personal dictionaries." t nil)
...
Migrate contacts from the org-contacts format." t nil)
...
(register-definition-prefixes "ebdb-mu4e" '("ebdb-"))
...
Display the EBDB record(s) for the sender of this message." t nil)

(autoload 'ebdb-mua-display-recipients "ebdb-mua" "\
Display the EBDB record(s) for the recipients of this message." t nil)

(autoload 'ebdb-mua-display-all-records "ebdb-mua" "\
Display the EBDB record(s) for all addresses in this message." t nil)

(autoload 'ebdb-mua-display-all-recipients "ebdb-mua" "\
Display EBDB records for all recipients of this message." t nil)
...
Edit the notes field of the EBDB record of the message sender." t nil)
...
(register-definition-prefixes "ebdb-notmuch" '("ebdb-"))
...
use one of the following, as appropriate:
 ...
 (add-hook 'mail-send-hook #'ebdb-pgp)" t nil)
...
Add this function to `ebdb-before-save-hook' and your .vm." t nil)
...
(register-definition-prefixes "ebdb-wl" '("ebdb-"))
